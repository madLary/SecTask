...
::grpc::ClientReader< ::employee::Employee>* EmployeeDb::Stub::GetListRaw(::grpc::ClientContext* context, const ::employee::GetListRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::employee::Employee>::Create(channel_.get(), rpcmethod_GetList_, context, request);
}

void EmployeeDb::Stub::async::GetList(::grpc::ClientContext* context, const ::employee::GetListRequest* request, ::grpc::ClientReadReactor< ::employee::Employee>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::employee::Employee>::Create(stub_->channel_.get(), stub_->rpcmethod_GetList_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::employee::Employee>* EmployeeDb::Stub::AsyncGetListRaw(::grpc::ClientContext* context, const ::employee::GetListRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::employee::Employee>::Create(channel_.get(), cq, rpcmethod_GetList_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::employee::Employee>* EmployeeDb::Stub::PrepareAsyncGetListRaw(::grpc::ClientContext* context, const ::employee::GetListRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::employee::Employee>::Create(channel_.get(), cq, rpcmethod_GetList_, context, request, false, nullptr);
}
...
::grpc::Status EmployeeDb::Stub::SetEmployeePost(::grpc::ClientContext* context, const ::employee::Setter& request, ::employee::StatusReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::employee::Setter, ::employee::StatusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SetEmployeePost_, context, request, response);
}

void EmployeeDb::Stub::async::SetEmployeePost(::grpc::ClientContext* context, const ::employee::Setter* request, ::employee::StatusReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::employee::Setter, ::employee::StatusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetEmployeePost_, context, request, response, std::move(f));
}

void EmployeeDb::Stub::async::SetEmployeePost(::grpc::ClientContext* context, const ::employee::Setter* request, ::employee::StatusReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::employee::StatusReply>* EmployeeDb::Stub::PrepareAsyncSetEmployeePostRaw(::grpc::ClientContext* context, const ::employee::Setter& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::employee::StatusReply, ::employee::Setter, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SetEmployeePost_, context, request);
}

::grpc::ClientAsyncResponseReader< ::employee::StatusReply>* EmployeeDb::Stub::AsyncSetEmployeePostRaw(::grpc::ClientContext* context, const ::employee::Setter& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status EmployeeDb::Stub::SetEmployeeLead(::grpc::ClientContext* context, const ::employee::Setter& request, ::employee::StatusReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::employee::Setter, ::employee::StatusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SetEmployeeLead_, context, request, response);
}

void EmployeeDb::Stub::async::SetEmployeeLead(::grpc::ClientContext* context, const ::employee::Setter* request, ::employee::StatusReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::employee::Setter, ::employee::StatusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetEmployeeLead_, context, request, response, std::move(f));
}

void EmployeeDb::Stub::async::SetEmployeeLead(::grpc::ClientContext* context, const ::employee::Setter* request, ::employee::StatusReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::employee::StatusReply>* EmployeeDb::Stub::PrepareAsyncSetEmployeeLeadRaw(::grpc::ClientContext* context, const ::employee::Setter& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::employee::StatusReply, ::employee::Setter, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SetEmployeeLead_, context, request);
}

::grpc::ClientAsyncResponseReader< ::employee::StatusReply>* EmployeeDb::Stub::AsyncSetEmployeeLeadRaw(::grpc::ClientContext* context, const ::employee::Setter& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
EmployeeDb::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< EmployeeDb::Service, ::employee::GetListRequest, ::employee::Employee>(
          [](EmployeeDb::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< EmployeeDb::Service, ::employee::Setter, ::employee::StatusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](EmployeeDb::Service* service,
             ::grpc::ServerContext* ctx,
             const ::employee::Setter* req,
             ::employee::StatusReply* resp) {
...
::grpc::Status EmployeeDb::Service::GetList(::grpc::ServerContext* context, const ::employee::GetListRequest* request, ::grpc::ServerWriter< ::employee::Employee>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status EmployeeDb::Service::SetEmployeePost(::grpc::ServerContext* context, const ::employee::Setter* request, ::employee::StatusReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status EmployeeDb::Service::SetEmployeeLead(::grpc::ServerContext* context, const ::employee::Setter* request, ::employee::StatusReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
